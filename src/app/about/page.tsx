    ...
    return (
        <main>
            ...
            >
                ...
                <ul className="mt-3 space-y-3 text-base leading-8 text-ink">
            ...
            >
                <p className="max-w-3xl text-lg leading-9 text-ink">
            ...
            <SectionShell title="Vision" intro="Efficiency. Equity. Innovation.">
                <article className="info-card max-w-4xl">
                    <p className="text-2xl text-ink md:text-3xl">
            ...
            <SectionShell title="Mission" intro="Scalable AI systems with real-world impact.">
                <article className="info-card max-w-4xl">
                    <p className="card-body text-lg text-ink">
            ...
            >
                <ul className="grid gap-4 md:grid-cols-3">
                    <li className="info-card card-body">Africa's digital skills gap is widening as AI adoption grows.</li>
                    <li className="info-card card-body">Most programmes remain concept-heavy and practice-light.</li>
                    <li className="info-card card-body">Institutions and SMEs need implementation support, not only advisory documents.</li>
                </ul>
            </SectionShell>
        </main>
    );
